...
{\scriptsize 
  ...
  \begin{table}
    \centering
    \begin{tabular}{ l  c  c  c  с  с  с  с }
     \multicolumn{8}{c}{Константы упругости, [$\cross 10^{10}$ Н/м$^2$]} \\
     \hline
      Источник & $c_{11}$ & $c_{12}$ & $c_{13}$ & $c_{14}$ & $c_{33}$ & $c_{44}$ & $c_{66}$ \\
      \hline
...
\column{7cm}
  \begin{table}
    ...
    \multicolumn{5}{c}{Пьезоэлектрические константы, [Кл/м$^2$]} \\
      \hline 
      Источник & $e_{15}$ & $e_{22}$ & $e_{31}$ & $e_{33}$  \\
      \hline
