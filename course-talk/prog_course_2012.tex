...
\frame{ 
  ...
  \center{Решение задачи о дифракции света с использованием  преобразования Фурье}
	...
	\begin{enumerate}
		...
		\item Переходим к Фурье-образу (разложению на плоские волны)
...
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/1slit/0.png}\\
\includegraphics[width=4cm,height=4cm]{pics/1slit/1.png}
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/1slit/3.png}\\
\includegraphics[width=4cm,height=4cm]{pics/1slit/9.png}
\end{columns}
}
...
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/2slits/0.png}\\
\includegraphics[width=4cm,height=4cm]{pics/2slits/1.png}
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/2slits/3.png}\\
\includegraphics[width=4cm,height=4cm]{pics/2slits/9.png}
\end{columns}
}
...
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/1square/0.png}\\
\includegraphics[width=4cm,height=4cm]{pics/1square/1.png}
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/1square/3.png}\\
\includegraphics[width=4cm,height=4cm]{pics/1square/7.png}
\end{columns}
}
...
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/4squares/0.png}\\
\includegraphics[width=4cm,height=4cm]{pics/4squares/3.png}
\column{.5\textwidth}
\centering
\includegraphics[width=4cm,height=4cm]{pics/4squares/7.png}\\
\includegraphics[width=4cm,height=4cm]{pics/4squares/9.png}
\end{columns}
}
