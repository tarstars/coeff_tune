// Оператор if: ввести из входного потока три целых числа a, b, c.
// Решить квадратное уравнение a*x^2 + b*x + c = 0 в действительных числах с разбором возможных вариантов.
// Возможные выводы программы: "one root: 12.5", "no roots" и т.д.
